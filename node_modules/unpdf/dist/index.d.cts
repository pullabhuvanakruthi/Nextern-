import { DocumentInitParameters, PDFDocumentProxy } from "./types/src/display/api.js";
import { Canvas, SKRSContext2D } from "@napi-rs/canvas";
import * as PDFJS from "./types/src/pdf.js";
//#region src/_internal/canvas.d.ts
...
declare class BaseCanvasFactory {
  ...
  create(width: number, height: number): {
    ...
    context: SKRSContext2D | CanvasRenderingContext2D | null;
  };
...
declare function createIsomorphicCanvasFactory(canvasImport?: () => Promise<typeof import('@napi-rs/canvas')>): Promise<typeof DOMCanvasFactory | typeof NodeCanvasFactory>;
//#endregion
...
declare function getMeta$1(data: DocumentInitParameters['data'] | PDFDocumentProxy, options?: {
  ...
  metadata: import("./types/src/display/metadata.js").Metadata;
}>;
//#endregion
...
//#endregion
export { type StructuredTextItem, configureUnPDF, createIsomorphicCanvasFactory, definePDFJSModule, extractImages, extractLinks, extractText, extractTextItems, getDocumentProxy, getMeta, getResolvedPDFJS, renderPageAsImage, resolvePDFJSImport };