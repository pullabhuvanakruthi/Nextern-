...
export class PDFFindController {
     ...
     */
    constructor({ linkService, eventBus, delay, updateMatchesCountOnProgress, }: PDFFindControllerOptions);
    ...
    _pdfDocument: import("../src/display/api.js").PDFDocumentProxy | null | undefined;
