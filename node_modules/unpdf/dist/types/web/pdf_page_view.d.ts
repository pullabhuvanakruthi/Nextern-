...
export class PDFPageView extends BasePDFPageView {
    ...
    rotation: number;
    scale: number;
    viewport: import("../src/display/page_viewport.js").PageViewport;
    ...
    _getRenderingContext(canvas: any, transform: any, recordOperations: any, recordImages: any): {
        ...
        optionalContentConfigPromise: Promise<import("../src/display/optional_content_config.js").OptionalContentConfig> | null;
