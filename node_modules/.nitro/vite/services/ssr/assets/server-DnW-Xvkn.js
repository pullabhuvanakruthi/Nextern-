...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-DXexIsEn.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CE189jQC.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DEwmGm74.js"),
		import("./start-inDaYGiO.js"),
