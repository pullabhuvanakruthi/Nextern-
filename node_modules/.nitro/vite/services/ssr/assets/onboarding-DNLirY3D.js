import { E as useStudentProfile, k as useUpdateStudentProfile } from "./ai-queries-D3oXUHn6.js";
...
import { a as DOMAINS, c as INTEREST_OPTIONS, f as STUDY_LEVELS, i as DEGREES, l as LOCATIONS, n as COMPANY_TYPES, o as DURATIONS, p as WORK_MODES, r as CURRENT_YEARS, s as GRADUATION_YEARS, u as SKILL_OPTIONS } from "./options-Br7fzcJ6.js";
import { t as Progress } from "./progress-ChzuiZwr.js";
import { t as Input } from "./input-NvmijQlt.js";
import { n as ChoiceChips, t as TagInput } from "./TagInput-CtBW2CUY.js";
import { n as ResumeUpload, t as Slider } from "./slider-DeFiYGs6.js";
...
//#region src/components/OnboardingFlow.tsx
var STEPS = [
	"Education",
	"Skills & resume",
	"Interests",
...
function OnboardingFlow() {
	...
	if (isLoading || !draft) return /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(Progress, { value: (step + 1) / STEPS.length * 100 }),
				/* @__PURE__ */ jsx("div", {
					...
					children: STEPS.map((s, i) => /* @__PURE__ */ jsxs("button", {
						...
						children: [i < step && /* @__PURE__ */ jsx(Check, { className: "mr-1 inline size-3" }), s]
					}, s))
				})
			]
		}), /* @__PURE__ */ jsx(Card, {
			...
			children: /* @__PURE__ */ jsxs(CardContent, {
				...
				children: [
					step === 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
						...
						/* @__PURE__ */ jsx(Field, {
							...
							children: /* @__PURE__ */ jsxs(Select, {
								...
								children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select your degree" }) }), /* @__PURE__ */ jsx(SelectContent, { children: DEGREES.map((d) => /* @__PURE__ */ jsx(SelectItem, {
									value: d,
									children: d
								}, d)) })]
							})
						}),
						draft.degree === "Other" && /* @__PURE__ */ jsx(Field, {
						...
						/* @__PURE__ */ jsx(Field, {
							label: "Study level",
							children: /* @__PURE__ */ jsx(ChoiceChips, {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Field, {
								...
								children: /* @__PURE__ */ jsxs(Select, {
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select year" }) }), /* @__PURE__ */ jsx(SelectContent, { children: CURRENT_YEARS.map((y) => /* @__PURE__ */ jsx(SelectItem, {
										value: y,
										children: y
									}, y)) })]
								})
								...
								children: /* @__PURE__ */ jsxs(Select, {
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select year" }) }), /* @__PURE__ */ jsx(SelectContent, { children: GRADUATION_YEARS.map((y) => /* @__PURE__ */ jsx(SelectItem, {
										value: y,
										children: y
									}, y)) })]
								})
					...
					step === 1 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Field, {
						label: "Your skills",
					...
					}), /* @__PURE__ */ jsx(ResumeUpload, { profile: saved })] }),
					step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Field, {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Button, {
							...
							children: [
								update.isPending && /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }),
