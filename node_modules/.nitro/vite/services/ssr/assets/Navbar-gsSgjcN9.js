import { S as useSaved, b as useReminderPrefs, g as useMarkNotificationRead, h as useInternships, i as useDismissReminder, l as useReminderDismissals, p as useClearNotifications, y as useNotifications } from "./ai-queries-D3oXUHn6.js";
import { n as useAuth } from "./auth-context-DxBoya-C.js";
import { n as cn, t as Button } from "./button-BpE9Czok.js";
import { t as Logo } from "./Logo-WxHpCbwH.js";
import * as React from "react";
import { useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Bell, Briefcase, Inbox, LogOut, Mail, Menu, Sparkles, Trash2, X } from "lucide-react";
...
function NotificationBell() {
	...
	return /* @__PURE__ */ jsxs(Popover, { children: [/* @__PURE__ */ jsx(PopoverTrigger, {
		...
		children: /* @__PURE__ */ jsxs(Button, {
			...
			children: [/* @__PURE__ */ jsx(Bell, { className: "size-5" }), unreadCount > 0 && /* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx(Inbox, { className: "size-8 text-muted-foreground/45 mb-2" }),
				/* @__PURE__ */ jsx("p", {
			...
			children: notifications.map((n) => /* @__PURE__ */ jsxs("li", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: n.type === "application_received" ? /* @__PURE__ */ jsx(Mail, { className: "size-3.5" }) : n.type === "application_update" ? /* @__PURE__ */ jsx(Sparkles, { className: "size-3.5" }) : /* @__PURE__ */ jsx(Briefcase, { className: "size-3.5" })
					}),
					/* @__PURE__ */ jsxs("div", {
					...
					!n.read && /* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-primary shrink-0 mt-2" })
				]
			}, n.id))
		})]
	})] });
...
//#endregion
//#region src/components/ReminderBell.tsx
...
function ReminderBell() {
	...
	return /* @__PURE__ */ jsxs(Popover, { children: [/* @__PURE__ */ jsx(PopoverTrigger, {
		...
		children: /* @__PURE__ */ jsxs(Button, {
			...
			children: [/* @__PURE__ */ jsx(Bell, { className: "size-5" }), reminders.length > 0 && /* @__PURE__ */ jsx("span", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
		...
		}), reminders.length === 0 ? /* @__PURE__ */ jsxs("p", {
			...
			className: "max-h-80 divide-y divide-border overflow-auto",
			children: reminders.map(({ internship, left, threshold }) => /* @__PURE__ */ jsxs("li", {
				className: "px-4 py-3",
				children: [
					/* @__PURE__ */ jsx(Link, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						user && /* @__PURE__ */ jsx(NotificationBell, {}),
						user && role !== "recruiter" && /* @__PURE__ */ jsx(ReminderBell, {}),
				...
				/* @__PURE__ */ jsxs(Sheet, {
					...
					children: [
						user && /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(NotificationBell, {}), role !== "recruiter" && /* @__PURE__ */ jsx(ReminderBell, {})]
						}),
