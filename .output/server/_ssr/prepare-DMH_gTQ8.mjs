...
import { E as useTestAttempts, T as useStudentProfile, l as useGenerateTest, u as useGradeTest } from "./ai-queries-D3oXUHn6.mjs";
import { n as cn, t as Button } from "./button-BpE9Czok.mjs";
import { O as ExternalLink, b as LoaderCircle, l as Sparkles, q as BookOpen } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/prepare-DMH_gTQ8.js
...
function PreparePage() {
	...
	const [topic, setTopic] = (0, import_react.useState)(() => {
		if (typeof window !== "undefined") return new URLSearchParams(window.location.search).get("topic") || "";
		return "";
	});
